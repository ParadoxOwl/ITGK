...
total = input('Total pris: ')
nPeople = input('Hvor mange deltok på middagen? ')
print(f'Ettersom dere var {nPeople} personer, så må hver person betale {float(total) / float(nPeople)}kr')
