...
print(f'Avrundet til to desimaler: {int(round(num, 2))}')
print(f'Avrundet til fire desimaler: {int(round(num, 4))}')
print(f'Avrundet til nærmeste tusen: {int(round(num, -3))}')
...
num = float(input('Skriv inn et flyttall: '))
deci = int(input('Hvor mange decimaler er ønskelig? '))
print(f'Tallet du skrev er {num} og med {deci} desimaler blir det til {round(num, deci)}')
