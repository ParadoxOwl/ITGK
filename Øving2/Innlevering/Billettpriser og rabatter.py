...
if days > 13:
    ...
    promt = input('Ønskes dette (J/N)? ')
    if promt == 'J':
        print('Takk of pengene, god reise!')
    else:
        alder = int(input('Skriv inn din alder: '))
        if alder < 16:
            print('Da koster billeten 220,-')
        elif alder > 60:
            print('Da koster billeten 330,-')
        elif input('Student eller militær i uniform? (J/N)') == 'J':
            print('Da koster billeten 330,-')
        else:
